...
const campoCro = document.getElementById("campoCro");
...
if (tipoUsuario) {
    tipoUsuario.addEventListener("change", alternarCampos);
    alternarCampos();
}
...
function filtrarTabela() {
    ...
    linhas.forEach(linha => {
        ...
        let correspondeStatus =
            ...
            (tab === "progresso" && status === "EmProducao") ||
            (tab === "concluidos" && status === "Concluido") ||
            (tab === "recolhidos" && status === "Recolhido") ||
            (tab === "entregues" && status === "Entregue");
...
function switchTab(tab) {
    ["todos", "pendentes", "progresso", "concluidos", "recolhidos", "entregues"].forEach(nome => {
    ...
    linhas.forEach(linha => {
        ...
        else if (tab === "recolhidos" && status === "Recolhido") {
            linha.style.display = "";
        }
        else if (tab === "entregues" && status === "Entregue") {
            linha.style.display = "";
        }
        else {
